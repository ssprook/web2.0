        ...
        <div className="flex flex-col md:flex-row">
          ...
          <div className="relative w-full md:w-5/12 bg-gradient-to-br from-red-500/20 to-purple-600/20 p-8 md:p-12 flex flex-col items-center justify-center text-center">
            ...
            <div className="relative">
              ...
              <p className="text-white/70 text-sm mb-8">Créez votre compte pour accéder à toutes les fonctionnalités premium</p>
              <div className="space-y-3">
                <div className="flex items-center gap-2 text-white/60 text-sm">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                  Analyse avancée illimitée
                </div>
                <div className="flex items-center gap-2 text-white/60 text-sm">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
          ...
          <div className="w-full md:w-7/12 p-8 md:p-12">
            <div className="max-w-md mx-auto">
              <h3 className="text-2xl font-bold text-white mb-8">Créer un compte</h3>
